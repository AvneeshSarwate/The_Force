...
midiPatternMap["responsivevis1"] = [
    ...
    {chan:1, paramNum: 0, paramTarget: .4, fadeTime: 6, lastMatched: -1, regex: br(/-53/), curve: (t)=> rampAD(t, .5)},
    {chan:1, paramNum: 0, paramTarget: .4, fadeTime: 6, lastMatched: -1, regex: br(/-65/)},
    ...
    {chan:1, paramNum: 5, paramTarget: 1, fadeTime: 6, lastMatched: -1, regex: br(/-43/), curve: (t)=> rampAD(t, .5)*2},
];
