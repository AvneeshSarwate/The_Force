...
var guitarPaintSliders = [
    ...
    {conf: {min: 0, max: 1, value: 0.75}, label: "10: color base"},
    {conf: {min: 0, max: 1, value: 0.225}, label: "11: color deviation"},
...
var cameraSinkSliders = [
    {conf: {min: 0, max: 1, value: 0.25}, label: "0: % camera feed"},
    {conf: {min: 0, max: 1, value: 0.2}, label: "1: warp depth"},
    {conf: {min: 0, max: 1, value: 0.5}, label: "2: color balance"},
    {conf: {min: 0, max: 1, value: 0.05}, label: "3: time offset only useful if speed is 0)"},
    {conf: {min: 0, max: 1, value: 0.05}, label: "4: warp resolution"},
    {conf: {min: 0, max: 1, value: 0.05}, label: "5: warp speed"},
    {conf: {min: 0, max: 1, value: 0.05}, label: "6: blank"},
    {conf: {min: 0, max: 1, value: 0.05}, label: "7: blank"},
    {conf: {min: 0, max: 1, value: 0.05}, label: "8: blank"},
    {conf: {min: 0, max: 1, value: 0.05}, label: "9: blank"},
    {conf: {min: 0, max: 1, value: 0.05}, label: "10: blank"},
    {conf: {min: 0, max: 1, value: 0.05}, label: "11: blank"},
...
var yoyoBodyVJSliders = [
    {conf: {min: 0, max: 1, value: 0.25}, label: "0: warp time speed"},
    {conf: {min: 0, max: 1, value: 0.2}, label: "1: video diff lag"},
    {conf: {min: 0, max: 1, value: 0.05}, label: "2: video speed"},
    {conf: {min: 0, max: 1, value: 0.5}, label: "3: noise amount"},
    {conf: {min: 0, max: 1, value: 0.05}, label: "4: warp amount"},
    {conf: {min: 0, max: 1, value: 0.05}, label: "5: trail amount"},
    {conf: {min: 0, max: 1, value: 0.05}, label: "6: hue base"},
    {conf: {min: 0, max: 1, value: 0.05}, label: "7: hue trail deviation"},
    {conf: {min: 0, max: 1, value: 0.05}, label: "8: blob huse deviation"},
